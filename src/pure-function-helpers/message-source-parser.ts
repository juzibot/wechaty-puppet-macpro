...
import { MacproMessageSource } from '../schemas'
import { xmlToJson } from './xml-to-json'

const PRE = 'messageSourceParser'

export async function messageSourceParser (messageSource: string): Promise<MacproMessageSource | null> {
  if (messageSource === '') {
    return null
  }
  ...
  try {
    ...
    const result: MacproMessageSource = {}
